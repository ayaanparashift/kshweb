        ...
        <div className="middleBlogContent flex lg:gap-20 gap-9 py-20 relative">
          ...
          <div className="colContnt">
            <h2 className="fsans-600 text-3xl pb-5">
              The Evolution of Grade A Industrial and Logistics Parks: Trends
              and Insights
            </h2>

            <div className="fsans-400 text-base leading-7 space-y-[18px] text-[#434343]">
              <p>
                The global supply chain landscape has undergone a significant
                transformation over the past two decades, driven by
                technological advancements, the rise of e-commerce, and a
                heightened focus on sustainability. In India, this shift is most
                evident in the evolution of Grade A industrial and logistics
                parks — facilities that go beyond basic storage to offer
                cutting-edge infrastructure, operational efficiency, and
                future-ready solutions.
              </p>
              <p>
                Grade A industrial and logistics parks have become the backbone
                of industries like manufacturing, e-commerce, FMCG, and
                logistics, catering to their need for seamless operations and
                scalable growth. At KSH INFRA, we have had the privilege of
                witnessing and shaping this transformation. Here, we share our
                insights into the evolution of Grade A industrial and logistics
                parks and the trends shaping their future.
              </p>
              <p>
