    ...
    >
      ...
      >
        <div className="ml-[max(5%,calc((100vw-1250px)/2))] md:mr-0 mr-[max(5%,calc((100vw-1250px)/2))]  flex flex-col w-auto lg:w-[75%] xl:w-[40%] py-[70px]">
          <LineHead heading="KSH INFRA Talegaon Park" />
          <motion.h3
            initial={{ opacity: 0 }}
          ...
          >
            Talegaon, located near the national highway connecting Mumbai and
          ...
          >
            The Talegaon hub comprises a number of industries including
