...
//////// 99999999999999999 888888888888888 &&&&&&&&&
//////// 99999999999999999 888888888888888 &&&&&&&&&
//////// 99999999999999999 888888888888888 &&&&&&&&&
//////// 99999999999999999 888888888888888 &&&&&&&&&
//////// 99999999999999999 888888888888888 &&&&&&&&&
...
//     const firstItem = timelineData[0];
//     if (firstItem) {
//       setHoveredYear(firstItem.id);
//       setTimeout(() => handleMouseEnter(firstItem.id), 100);
//     }
//   }, []);
...
const Timeline = () => {
  ...
  return (
    <div className="bg-cover relative bg-no-repeat bg-center py-10">
      ...
      <div className="px-10 pb-12 z-10 relative flex flex-col items-center">
        ...
        {selectedYear && (
          ...
          >
            ...
            ></div>
            <div className="flex xl-1024:w-[330px] w-[480px] h-[210px]">
              <img
                src={
                  timelineData.find((item) => item.id === selectedYear)?.image
                }
                alt="event"
                className="w-[210px] min-h-full object-cover"
              />
              <div className="bg-white w-full py-3 px-2 space-y-2">
                <h3 className="fpt-500 text-4xl text-[#092241] leading-9 font-bold">
                  {timelineData.find((item) => item.id === selectedYear)?.year}
                </h3>
                <p className="pt-2 fsans-400 text-sm text-[#474747]">
      ...
      <div className="flex gap-[14px] relative z-10  items-center justify-center">
        <button className="arrowleft flex items-center justify-center">
          <img
            className="w-[40px] h-[40px]"
            src="/AboutPage/timeline/whitearrowleft.svg"
